...
LINT_RULES = {
    ...
    "slow_component_execution": {
        "id": "GH016",
        "severity": "warning",
        "title": "Slow Component Execution",
        "description": "Components taking longer than 100ms to execute",
        "why_it_matters": "Slow components impact document responsiveness and user experience",
        "how_to_fix": "Optimize algorithms, reduce data size, use caching, or simplify geometry"
    },

    "performance_bottleneck": {
        "id": "GH017",
        "severity": "info",
        "title": "Computational Bottleneck",
        "description": "Components consuming disproportionate computation time (>20% of total)",
        "why_it_matters": "These are prime optimization targets for overall performance gains",
        "how_to_fix": "Profile component internals, optimize data structures, or consider alternative approaches"
    },

    "heavy_preview_geometry": {
        "id": "GH018",
        "severity": "info",
        "title": "Heavy Preview Geometry",
        "description": "Components generating large preview geometry with preview enabled",
        "why_it_matters": "Preview generation can slow viewport interaction and canvas refresh",
        "how_to_fix": "Disable preview on heavy geometry components or use Custom Preview selectively"
    }
}
